...
explorant mida absoluta i ecologia
...
simSYM <- make.simmap(ctree, ecoAll, nsim=10, model = "SYM", Q="empirical") # nsim= Nombre de reconstruccions
...
plotSimmap(simSYM[[1]],fsize=0.25,col=cols) ## Plot simmap number 1 (si canvies 1, pots veure els altres)
